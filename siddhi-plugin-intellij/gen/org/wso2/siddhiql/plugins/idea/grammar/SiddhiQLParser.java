...
public class SiddhiQLParser extends Parser {
	...
	public static class Execution_planContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SiddhiQLListener ) ((SiddhiQLListener)listener).enterExecution_plan(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SiddhiQLListener ) ((SiddhiQLListener)listener).exitExecution_plan(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SiddhiQLVisitor ) return ((SiddhiQLVisitor<? extends T>)visitor).visitExecution_plan(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Plan_annotationContext extends ParserRuleContext {
		public TerminalNode PLAN() { return getToken(SiddhiQLParser.PLAN, 0); }
		public NameContext name() {
			return getRuleContext(NameContext.class,0);
		}
		public List<Annotation_elementContext> annotation_element() {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SiddhiQLListener ) ((SiddhiQLListener)listener).enterPlan_annotation(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SiddhiQLListener ) ((SiddhiQLListener)listener).exitPlan_annotation(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SiddhiQLVisitor ) return ((SiddhiQLVisitor<? extends T>)visitor).visitPlan_annotation(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Query_outputContext extends ParserRuleContext {
		...
		public TerminalNode OVERWRITE() { return getToken(SiddhiQLParser.OVERWRITE, 0); }
		public TerminalNode RETURN() { return getToken(SiddhiQLParser.RETURN, 0); }
	...
	public static class Stream_aliasContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SiddhiQLVisitor ) return ((SiddhiQLVisitor<? extends T>)visitor).visitStream_alias(this);
			else return visitor.visitChildren(this);
		}
	}
